...
### تنظیم اولویت از UI ⭐ (جدید!)

**✨ حالا می‌توانید Priority را مستقیم از UI تغییر دهید!**

#### مراحل:
1. رفتن به لیست Collector Channels
2. در ستون **"Priority"** dropdown را باز کنید
3. یکی از این گزینه‌ها را انتخاب کنید:
   - 🔴 **High** - اولویت بالا
   - **Normal** - عادی
   - **Low** - کم‌اهمیت
4. Priority به صورت خودکار ذخیره می‌شود ✅

**مزایا:**
- ✅ ساده و سریع
- ✅ نیازی به دسترسی دیتابیس ندارد
- ✅ تغییرات فوری اعمال می‌شوند
- ✅ پیام موفقیت نمایش داده می‌شود
- ✅ دکمه "Sync Now" برای HIGH priority ظاهر می‌شود

---

### تنظیم اولویت از دیتابیس (روش قدیمی)
