...
| `dataHub.logs` | Access Logs | `LogsPanel.tsx` | `GET /api/v1/data-sources/access-logs` | `data_hub_logs` | -- | Implemented | `useAccessLogsQuery` + `dataAccessLogsApi.ts` + `GET /access-logs` (GAP-013 Closed). |
