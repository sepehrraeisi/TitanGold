...
| `dataHub.advanced.automation` | Automation / Routing | `AutomationTopics.tsx` | `/api/v1/data-hub/automation` | `datahub_automation_topics`, `datahub_automation_queue`, `datahub_automation_schedule`, `datahub_automation_executions` | manual dispatch + publisher API | Implemented | GAP-018 Closed · GAP-019 Closed · GAP-020 (cron worker v3.1) Open. Global topic routing: `/api/v1/topic-routing` (AI Center). |
