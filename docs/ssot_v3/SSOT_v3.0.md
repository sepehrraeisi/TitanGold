...
| `dataHub.advanced.access` | Access Control | `AccessControlPanel.tsx` | `GET/POST/DELETE /api/v1/data-hub/access-control` | `source_access_controls` | -- | Implemented (backend) | GAP-022: wiring + Design Pass done v3.0. Design debt backlog: `DATAHUB_DESIGN_BACKLOG.md`. |
...
| `dataHub.advanced.automation` | Automation / Routing | `AutomationTopics.tsx` | `/api/v1/data-hub/automation` | `datahub_automation_topics`, `datahub_automation_queue`, `datahub_automation_schedule`, `datahub_automation_executions` | manual dispatch + publisher API | Implemented | GAP-018/019 Closed (migration verified 2026-05-24). GAP-020 cron worker v3.1 Open. |
