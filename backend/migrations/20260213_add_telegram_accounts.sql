-- 2026-02-13: Multi-Account Telegram Collector - telegram_accounts & channel linkage

-- 1) Create telegram_accounts table for multi-account support
...
-- 2) Link telegram_channels to telegram_accounts via optional account_id
