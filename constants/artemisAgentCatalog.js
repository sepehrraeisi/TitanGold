...
export const ARTEMIS_AGENT_CATALOG = [
  ...
  { key: 'timing', aliases: ['timing'], registryKey: 'timing', nameKey: 'artemis_agent_timing', group: 'opportunity', authority: 'forecast' },
  ...
  { key: 'portfolio', aliases: ['portfolio', 'portfolio_allocation'], registryKey: 'portfolio', nameKey: 'artemis_agent_portfolio', group: 'capital_risk', authority: 'sizing' },
  { key: 'optimization', aliases: ['optimization'], registryKey: 'optimization', nameKey: 'artemis_agent_optimization', group: 'capital_risk', authority: 'sizing' },
