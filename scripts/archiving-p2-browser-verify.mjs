...
async function main() {
    ...
    await page.getByRole('tab', { name: 'Data Hub' }).click();
    await page.waitForTimeout(2000);
    ...
    await page.getByText('Archive partitions').scrollIntoViewIfNeeded();
    await page.screenshot({ path: path.join(OUT, 'archiving-p2-partitions.png'), fullPage: true });
    await page.getByText('Recent operations').scrollIntoViewIfNeeded();
